...
- **対応 US**: US-001, US-002, US-004, US-005, US-006, US-008, US-009, US-010, US-011
...
| Deadline | 日時入力 | 170px | `<input type="datetime-local">`。オプション (null 許容)。変更で即 PUT 発行 (US-008)。フォント 13px |
...
| 要素 | 仕様 |
|------|------|
| グループ見出し行 | 各カテゴリの先頭に `colspan=7` の見出し行を挿入。カテゴリ名を表示 |
...
| Deadline | 13px | 補助情報。Todo より一段小さく |
