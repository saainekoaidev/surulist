...
- **対応 US**: US-001, US-002, US-004, US-005, US-006, US-008, US-009, US-010, US-011, US-012, US-013
...
| Date | 日付入力 | 130px | `<input type="date">`。オプション (null 許容)。フォント 13px (US-013) |
| Time | 時刻入力 | 90px | `<input type="time">`。Date と合わせて deadline を構成。フォント 13px (US-013) |
| RegistDate | 登録日時 | 110px | `YYYY/M/D H:mm` 形式。読み取り専用。フォント 11px (US-009) |
| UpdateDate | 更新日時 | 110px | 同上。未更新時は空欄。フォント 11px (US-009) |
...
| 要素 | サイズ | 根拠 |
|------|--------|------|
| Todo テキスト | 14px | 主要情報。最も大きく表示 |
| Date / Time | 13px | 補助情報。Todo より一段小さく (US-013: Deadline を分割) |
| RegistDate / UpdateDate | 11px | メタ情報。最も控えめに |
| テーブルヘッダ (一般) | 12px | 列見出し |
| テーブルヘッダ (日付列) | 10px | 日付列に合わせて縮小 |
